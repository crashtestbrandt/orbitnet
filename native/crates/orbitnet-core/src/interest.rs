...
//! member. Relevancy is a property of a viewpoint; a delta base and a byte budget are properties of
//! a datagram. A connection with one seat is filtered exactly as it was before seats existed.
//!
